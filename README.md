# [Nguyen Thu An Le] – Data & Analytics Portfolio
...
- [Portfolio Projects](#portfolio-projects)
  ...
  - SQL
  - Tableau / Power BI
    - Home Credit Loan Application Risk Dashboard Code & full write-up: [Home Credit Loan Application Risk Dashboard](https://github.com/AnnLe04/-Home-Credit-Loan-Risk-Dashboard) 4-page interactive dashboard analyzing default risk across 308K consumer loan applications ($184B portfolio) for a non-prime lender, mirroring the alternative lending space. Identified occupation and education as the strongest risk signals through segment analysis and a cross-tab deep dive, validated against sample-size reliability. Tools: Power BI, Power Query, DAX.
- [Education](#education)
